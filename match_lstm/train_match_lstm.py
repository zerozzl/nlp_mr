...
from match_lstm.model import MatchLSTM
...
def get_dataset(args, tokenizer, bigram_tokenizer):
    train_dataset = MrDataset('%s/%s/train.json' % (args.data_path, args.task), args.token_type, tokenizer,
                              ...
                              max_question_len=args.max_question_len, do_pad=True, do_to_id=True, do_sort=True,
...
def main(args):
    ...
    if args.pretrained_model_path is not None:
        ...
        model = MatchLSTM(len(token_to_id), args.embed_size, args.hidden_size,
